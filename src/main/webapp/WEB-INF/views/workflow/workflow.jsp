...
<body>
		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <!--<s:if test="#depList!=null && #depList.size()>0">
		      	...
		      	<!-- 这里判断是否为空 -->
		      	<c:forEach items="${sessionScope.depList}" var="dep">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${dep.deploymentTime}</div></td>
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a href="workflow_del_deploy.do?deploymentId=${dep.id}">删除</a>
				        </div></td>
				    </tr> 
				 </c:forEach>
		      	<!--</s:iterator>
		  ...
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
		      ...
		      <!--<s:if test="#pdList!=null && #pdList.size()>0">
		      	...
		      	<!-- 这里判断是否为空 -->
		      	<c:forEach items="${sessionScope.pdList}" var="pd">
		      		<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21">
				        	<a target="_blank" href="workflow_getPic.do?deploymentId=${pd.deploymentId }&diagramResourceName=${pd.diagramResourceName }">查看流程图</a> 
					 	</div></td>
				    </tr> 
		      	<!--</s:iterator>
		      </s:if>-->
	...
	<br/>
	<!-- 发布流程 -->
	<form action="/WebActiviti/workflow_deploy.do" enctype="multipart/form-data" method="POST">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
		    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		  ...
		  <tr>
		    <td>
		    	<div align="left" class="STYLE21">
					流程名称：<input type="text" name="flowName" Style="width: 200px;"/><br/>
					流程文件:<input type="file" name="upload_file" Style="width: 200px;"/><br/>
					<input type="submit" value="上传流程" class="button_ok" Style="margin-top:10px;height:25px"/><br/>
				</div>
		    </td>
		  </tr>
	</table>
