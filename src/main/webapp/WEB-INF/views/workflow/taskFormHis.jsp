...
<body>
		  ...
		  <tr>
		  	<td>
			  		<div align="left" class="STYLE21">
				 		请假天数:<input type="text" name="days" value="${leaveBillHis.days }" disabled="true" Style="width: 200px;"/><br/>
				 		请假原因:<input type="text" name="content" value="${leaveBillHis.content }" disabled="true" Style="width: 800px;"/><br/>
				 		请假备注:<textarea name="remark" disabled="true" cols="30" rows="2">${leaveBillHis.remark }</textarea><br/>
				 		<input type="button" name="button" value="返回" class="button_ok" onclick="javascript:history.go(-1);" Style="margin-top:10px;height:25px" />
			 		</div>
		  	</td>
		  </tr>
	</table>
	<hr>
	<br>
		<c:if test="${fn:length(sessionScope.hisComment)!=0}">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			  <tr>
			    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			  ...
			  <tr>
			    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
			      ...
			      <c:forEach items="${sessionScope.hisComment}" var="comment">
			      	<tr>
